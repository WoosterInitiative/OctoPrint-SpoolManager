...
plugin_author = "OllisGit, WoosterInitiative"

# The plugin's author's mail address.
plugin_author_email = "ollisgit@gmail.com, karl@woostertech.com"
...
plugin_requires = [
    "pillow >= 6.2.0, < 7.0.0 ; python_version < 3",
    "pillow >= 6.2.0, == 9.*; python_version >= 3.7",
    "qrcode ~= 7.3",
    "peewee ~= 3.14",
